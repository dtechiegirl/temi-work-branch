...
<!-- Mirrored from templates.envytheme.com/luvion/default/index-7.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Apr 2023 08:04:34 GMT -->
<head>
        <!-- Required meta tags -->
        <meta charset="utf-8">
                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item"><a href="#" class="nav-link active">Home <i class="fas fa-chevron-down"></i></a>
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item"><a href="index-7.html" class="nav-link active">Currency Transfer Provider</a></li>
                                    </ul>
                                </li>

                                <li class="nav-item"><a href="about-two.html" class="nav-link">About Us</a></li>

                                <li class="nav-item"><a href="how-it-works.html" class="nav-link">How It Works</a></li>

                                <li class="nav-item"><a href="contact-two.html" class="nav-link">Contact Us</a></li>
                            </ul>
                                    ...
                                    <div class="dropdown language-option">
                                        ...
                                        <div class="dropdown-menu language-dropdown-menu">
                                            <a class="dropdown-item" href="#">
                                                <img src="{{asset('assets/img/currency-transfer-provider/uk.png')}}" alt="flag">
                                                EN
                                            </a>
                                            <a class="dropdown-item" href="#">
                                                <img src="{{asset('assets/img/currency-transfer-provider/china.png')}}" alt="flag">
                                                简体中文
                                            </a>
                                            <a class="dropdown-item" href="#">
                                                <img src="{{asset('assets/img/currency-transfer-provider/uae.png')}}" alt="flag">
                                                العربيّة
                                            </a>
                                        </div>
                                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-12">
                        <div class="ctp-banner-content">
                            ...
                            <ul class="ctp-list">
                                <li> 
                                    <img src="{{asset('assets/img/currency-transfer-provider/banner/circle-check.svg')}}" alt="image"> 
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="{{asset('assets/img/currency-transfer-provider/countries/img1.png')}}" alt="image">
                                <span>USA</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="{{asset('assets/img/currency-transfer-provider/countries/img2.png')}}" alt="image">
                                <span>UK</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="{{asset('assets/img/currency-transfer-provider/countries/img3.png')}}" alt="image">
                                <span>New Zealand</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="{{asset('assets/img/currency-transfer-provider/countries/img4.png')}}" alt="image">
                                <span>France</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="{{asset('assets/img/currency-transfer-provider/countries/img5.png')}}" alt="image">
                                <span>Germany</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="{{asset('assets/img/currency-transfer-provider/countries/img6.png')}}" alt="image">
                                <span>Italy</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="{{asset('assets/img/currency-transfer-provider/countries/img7.png')}}" alt="image">
                                <span>Greece</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="{{asset('assets/img/currency-transfer-provider/countries/img8.png')}}" alt="image">
                                <span>China</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="{{asset('assets/img/currency-transfer-provider/countries/img9.png')}}" alt="image">
                                <span>Kuwait</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="{{asset('assets/img/currency-transfer-provider/countries/img10.png')}}" alt="image">
                                <span>Argentina</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="{{asset('assets/img/currency-transfer-provider/countries/img11.png')}}" alt="image">
                                <span>Sweden</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="{{asset('assets/img/currency-transfer-provider/countries/img12.png')}}" alt="image">
                                <span>Thailand</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6">
                            <div class="ctp-money-transfer-card">
                                ...
                                <div class="image">
                                    <img src="{{asset('assets/img/currency-transfer-provider/money-transfer/customer.png')}}" alt="image">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="ctp-money-transfer-card">
                                ...
                                <div class="image">
                                    <img src="{{asset('assets/img/currency-transfer-provider/money-transfer/profits.png')}}" alt="image">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="ctp-money-transfer-card">
                                ...
                                <div class="image">
                                    <img src="{{asset('assets/img/currency-transfer-provider/money-transfer/data.png')}}" alt="image">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-3 col-sm-6">
                            <div class="ctp-services-card">
                                <h3>
                                    <div class="icon">
                                        <img src="{{asset('assets/img/currency-transfer-provider/services/mobile-payment.svg')}}" alt="image">
                                    </div>
                                    Regular Payments
                                </h3>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="ctp-services-card">
                                <h3>
                                    <div class="icon">
                                        <img src="{{asset('assets/img/currency-transfer-provider/services/warning.svg')}}" alt="image">
                                    </div>
                                    Rate Alerts
                                </h3>
                                <p>Mauris blandit aliquet elit, eget tincidunt nibh pulvinar. quisque velit nisi, pretium ut lacinia in, elementum id enim. proin eget tortor risus. proin eget tortor risus.</p>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="ctp-services-card">
                                <h3>
                                    <div class="icon">
                                        <img src="{{asset('assets/img/currency-transfer-provider/services/fluctuation.svg')}}" alt="image">
                                    </div>
                                    Market Analysis
                                </h3>
                                <p>Mauris blandit aliquet elit, eget tincidunt nibh pulvinar. quisque velit nisi, pretium ut lacinia in, elementum id enim. proin eget tortor risus. proin eget tortor risus.</p>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="ctp-services-card">
                                <h3>
                                    <div class="icon">
                                        <img src="{{asset('assets/img/currency-transfer-provider/services/contract.svg')}}" alt="image">
                                    </div>
                                    Spot Contracts
                                </h3>
                                <p>Mauris blandit aliquet elit, eget tincidunt nibh pulvinar. quisque velit nisi, pretium ut lacinia in, elementum id enim. proin eget tortor risus. proin eget tortor risus.</p>
                        ...
                        <div class="col-lg-6 col-md-12 p-0">
                            <div class="ctp-working-people-content">
                                ...
                                <div class="working-people-inner-card">
                                    <div class="icon">
                                        <img src="{{asset('assets/img/currency-transfer-provider/working-people/save-time.svg')}}" alt="image">
                                    </div>
                                    <h4>Save time</h4>
                                    <p>Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae donec velit neque, auctor sit amet aliquam vel, ullamcorper sit amet ligula. donec rutrum congue leo eget malesuada.</p>
                                </div>
                                ...
                                <div class="working-people-inner-card">
                                    <div class="icon">
                                        <img src="{{asset('assets/img/currency-transfer-provider/working-people/money-saving.svg')}}" alt="image">
                                    </div>
                                    <h4>Save money</h4>
                                    <p>Nulla porttitor accumsan tincidunt. quisque velit nisi, pretium ut lacinia in, elementum id enim. praesent sapien massa, convallis a pellentesque nec, egestas non nisi. sed porttitor lectus nibh.</p>
                                </div>
                                ...
                                <div class="working-people-inner-card">
                                    <div class="icon">
                                        <img src="{{asset('assets/img/currency-transfer-provider/working-people/secure.svg')}}" alt="image">
                                    </div>
                                    <h4>Send securely</h4>
                    ...
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="ctp-app-image">
                                <img src="{{asset('assets/img/currency-transfer-provider/app/app.png')}}" alt="image">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6">
                            <div class="ctp-reviews-box">
                                <ul class="rating">
                                    <li>
                                        <img src="{{asset('assets/img/currency-transfer-provider/star.svg')}}" alt="image">
                                    </li>
                                    <li>
                                        <img src="{{asset('assets/img/currency-transfer-provider/star.svg')}}" alt="image">
                                    </li>
                        ...
                        <div class="accordion" id="FaqAccordion">
                            <div class="accordion-item">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                    How do I create an account with Luvion?
                                </button>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-3 col-sm-6 col-md-6">
                        <div class="ctp-footer-widget">
                            <div class="logo">
								<a href="index-7.html"><img src="assets/img/logo.png" alt="logo"></a>
							</div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-md-6">
                        <div class="ctp-footer-widget">
                            ...
                            <ul class="info">
                                ...
                                <li>
                                    <span>Email: </span>
                                    <a href="https://templates.envytheme.com/cdn-cgi/l/email-protection#82eef7f4ebedecc2e5efe3ebeeace1edef"><span class="__cf_email__" data-cfemail="365a43405f595876515b575f5a1855595b">[email&#160;protected]</span></a>
                                </li>
                                <li>
                                    <span>Email: </span>
        ...
        <script src="{{asset('assets/js/meanmenu.')}}'"></script>
...
<!-- Mirrored from templates.envytheme.com/luvion/default/index-7.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Apr 2023 08:07:15 GMT -->
</html>